...
$('.mailchimp').ajaxChimp({
    ...
    url: "//roompal.us8.list-manage.com/subscribe/post?u=2a08e441af912498c6a3c73b3&amp;id=71b409f796"  //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
});
...
$('.js-feature-hover').hover(
    function(){
        var related = $(this).attr('rel');
       $('.feature-img').removeClass('show');
